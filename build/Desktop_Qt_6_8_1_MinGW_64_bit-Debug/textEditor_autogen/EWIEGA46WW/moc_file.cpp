...
static constexpr auto qt_meta_stringdata_ZN4FileE = QtMocHelpers::stringData(
    "File",
    "filePath",
    "",
    "str"
...
Q_CONSTINIT static const uint qt_meta_data_ZN4FileE[] = {
...
Q_CONSTINIT const QMetaObject File::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN4FileE.offsetsAndSizes,
    qt_meta_data_ZN4FileE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN4FileE_t,
        // Q_OBJECT / Q_GADGET
...
void File::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (File::*)(const QString & );
            if (_q_method_type _q_method = &File::filePath; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *File::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN4FileE.stringdata0))
